...
from wide_deep_evaluate_tools_byID import *
import pickle
...
for K in [50, 100, 200, 400]:
    ...
    save_path_best_ranks_val = 'best_ranks_val_{}_byID'.format(K)
    save_path_rec_posts_val = 'rec_posts_val_{}_byID'.format(K)
    ...
    save_path_best_ranks_test = 'best_ranks_test_{}_byID'.format(K)
    save_path_rec_posts_test = 'rec_posts_test_{}_byID'.format(K)
